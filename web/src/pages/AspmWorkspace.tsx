...
/**
 * Application Security (ASPM) workspace.
 * Features a toggle flag `SHOW_COMING_SOON` to show the clean Coming Soon popup now
 * and instantly reveal all full pages when toggled.
 */
export default function AspmWorkspace() {
  ...
  // If Coming Soon mode is active, render the clean single-screen popup card
  if (SHOW_COMING_SOON) {
    return (
      <div className="relative min-h-[75vh] flex items-center justify-center p-4">
        <div className="relative w-full max-w-md bg-white border border-slate-200/90 rounded-3xl shadow-[0_10px_40px_rgba(0,0,0,0.06)] p-6 sm:p-8 text-center z-10 my-auto overflow-hidden">
          ...
          <div className="inline-flex items-center gap-2 px-3.5 py-1 rounded-full bg-blue-50/90 border border-blue-200/80 text-blue-700 text-xs font-semibold font-mono tracking-wider uppercase mb-3 shadow-xs animate-pulse">
            ...
            <span>APPLICATION SECURITY (ASPM)</span>
          </div>

          {/* Headline with reduced font weight (font-semibold/600) & subtle text gradient shimmer animation */}
          ...
          <div className="flex items-center justify-center gap-2 text-[11px] font-mono text-slate-500 border-t border-slate-100 pt-4">
            ...
            <span className="font-semibold text-slate-700">UNDER ACTIVE DEVELOPMENT</span>
          </div>
  ...
  // Full Active ASPM Workspace (Revealed when SHOW_COMING_SOON is false)
  return (
